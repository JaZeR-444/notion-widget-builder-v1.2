...
export const imageGalleryConfig = {
  ...
  defaultConfig: {
    ...
    // Style Options
    slideBackgroundColor: JAZER_BRAND.colors.stardustWhite,
    textColor: JAZER_BRAND.colors.nightBlack,
    dropShadows: false,
    transparentBackground: false, // Initially locked
    setBackgroundColor: true,

    // Color Customization
    arrowColorLight: JAZER_BRAND.colors.graphite,
    arrowColorDark: JAZER_BRAND.colors.stardustWhite,
    dotsColorLight: JAZER_BRAND.colors.graphite,
    dotsColorDark: JAZER_BRAND.colors.stardustWhite,
