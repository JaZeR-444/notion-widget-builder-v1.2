...
export const quotesConfig = {
  ...
  defaultConfig: {
    ...
    backgroundColor: '#F8F9FF', // JAZER_BRAND.colors.stardustWhite - will be replaced
    ...
    // Color Customization
    textColorLight: '#0B0E12', // JAZER_BRAND.colors.nightBlack - will be replaced
    textColorDark: '#F8F9FF', // JAZER_BRAND.colors.stardustWhite - will be replaced
    quoteBackgroundLight: '#F8F9FF', // JAZER_BRAND.colors.stardustWhite - will be replaced
    quoteBackgroundDark: '#1A1D29', // JAZER_BRAND.ui.deepSpace - will be replaced
    refreshIconColor: '#8B5CF6', // JAZER_BRAND.colors.electricPurple - will be replaced
    authorColor: '#06B6D4', // JAZER_BRAND.colors.aetherTeal - will be replaced
